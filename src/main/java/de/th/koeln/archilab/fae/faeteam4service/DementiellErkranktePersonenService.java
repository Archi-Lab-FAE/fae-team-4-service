...
public class DementiellErkranktePersonenService {
  ...
  public DementiellErkranktePersonenService(DementiellErkranktePersonRepository dementiellErkranktePersonRepository) {
    this.dementiellErkranktePersonRepository = dementiellErkranktePersonRepository;
  }

  public List<DementiellErkranktePerson> getPersonenInProximityOf(final Alarmknopf alarmknopf, final double radiusInMeters) {
    ...
    for (DementiellErkranktePerson dementiellErkranktePerson : allPersonen) {
      DistanceInMeters distanceInMeters = getDistanceInMeters(alarmknopf, dementiellErkranktePerson);
  ...
  private DistanceInMeters getDistanceInMeters(Alarmknopf alarmknopf, DementiellErkranktePerson dementiellErkranktePerson) {
